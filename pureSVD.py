...
if __name__=="__main__":
    ...
    '''
    recommend.main(method='lda',topics=50)
    ...
    for u in test_users.keys():
      if u in training_users.keys():
        for i in test_users[u].keys():
          if i in training_items.keys():
            count += 1
            #TODO encapsulate it
            user_items = []
            ...
            # pdb.set_trace()
            # item_ids = recommend.recommend_for_user(u)
            ...
            recommendations = ranker.maximizeKGreatItems(20, ratings, training_items)
